/* ======== EINKOMMENSSTEUR RECHNER ======== */


// Variables 
const income = document.querySelector('#income');
const single = document.querySelector('#zVESingle')
const year = document.querySelector('#year');


// check the checked state of the zVE radio inputs
function checkState() {
    let zVEinitial = income;
    let zVESingle = single;
...
// calculate tax amount to output for different years
function calcTax() { 

const zVE = Number(zVEFinal);
// console.log(zVE);
